...
--             (scripts/apertura/inventario_apertura.csv, 647 renglones de origen).
...
-- ---------------------------------------------------------------------------
--
-- ALCANCE: 336 de los 647 renglones del CSV, los que tienen
-- codigo_interno ya cargado en gmp.insumos_catalogo. Los 294 restantes
...
begin
  ...
  values (
    '2026-09-16',
    '05 INVENTARIO NAIL SHOW FABRICA (inventario_apertura.csv)',
    'd43f8933735dee77d98aeb8e9bc33f8cdbe57b7b6e8075af7411f6344b2af977',
    v_ejecutada_por,
    '336 de 647 renglones de origen importados. El resto (herramientas, mobiliario, merchandising, libros) queda fuera del catálogo de insumos y listado en scripts/apertura/pendientes.md.'
  )
  ...
  from (
    values
    ('080POL', 1, false, 'SALDO DE APERTURA — KEYSTONE', 'VERDE'),
    ...
    ('080ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('081ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('082ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('083ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('084ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('085ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('086ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('087ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('088ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('089ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('090ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('091ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('092ET', 54, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('093ENV', 1, false, 'SALDO DE APERTURA — CHIBI', 'ROJO'),
    ('093ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('094ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('095ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('096ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('097ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('098ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('099ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('100ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('101ESE', 1, false, 'SALDO DE APERTURA — EUMA', 'VERDE'),
    ...
    ('111G', 1000, false, 'SALDO DE APERTURA — NGM', 'ROJO'),
    ('111ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('112ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('113ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('114ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('115ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('116ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('117ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('118ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('119ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('279ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('278ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('299ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('327ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('120ET', 150, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('111CAJ', 1, false, 'SALDO DE APERTURA — CREAPACK', 'ROJO'),
    ('111ETT', 96, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('111ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('112ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('113ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('114ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('115ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('116ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('117ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('118ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('119ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('279ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('278ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('299ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('327ETC', 48, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('300ENV', 1344, false, 'SALDO DE APERTURA — DONGGUAN', 'ROJO'),
    ('300G', 1000, false, 'SALDO DE APERTURA — NGM', 'ROJO'),
    ('300ETT', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('300ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('301ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('302ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('303ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('304ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('305ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('306ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('307ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('308ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('309ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('310ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('311ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('312ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('313ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('314ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('315ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('316ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('317ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('318ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('319ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('331ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('332ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('333ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('334ETB', 204, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('122ENV', 1344, false, 'SALDO DE APERTURA — DANO', 'ROJO'),
    ('130ENV', 1, false, 'SALDO DE APERTURA — CRISTALMAN', 'ROJO'),
    ('130ET', 114, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('131ET', 195, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('131AC', 1, false, 'SALDO DE APERTURA — MAHO', 'VERDE'),
    ('132ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('133ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('134ET', 16, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('136ET', 195, false, 'SALDO DE APERTURA — ELGART', 'AMARILLO'),
    ('137ET', 195, false, 'SALDO DE APERTURA — ELGART', 'VERDE'),
    ...
    ('378ACE', 0, true, 'SALDO DE APERTURA — EVIDENS', 'VERDE'),
